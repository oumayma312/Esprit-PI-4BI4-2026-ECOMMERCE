...
with mlflow.start_run(run_name="Random Forest"):
    ...
    mlflow.log_metric("precision_weighted", precision_score(y_test, y_pred_rf, average="weighted", zero_division=0))
    mlflow.log_metric("recall_weighted", recall_score(y_test, y_pred_rf, average="weighted", zero_division=0))
    mlflow.log_metric("f1_weighted", f1_score(y_test, y_pred_rf, average="weighted", zero_division=0))
    mlflow.log_metric("roc_auc_weighted", roc_auc_rf)
    mlflow.log_metric("cv_f1_mean", cv_scores_rf.mean())
    mlflow.log_metric("cv_f1_std", cv_scores_rf.std())

    mlflow.sklearn.log_model(best_rf, "model")


# =============================================================================
# MLFLOW TRACKING — LOGISTIC REGRESSION
# =============================================================================
with mlflow.start_run(run_name="Logistic Regression"):
    ...
    mlflow.log_metric("precision_weighted", precision_score(y_test, y_pred_lr, average="weighted", zero_division=0))
    mlflow.log_metric("recall_weighted", recall_score(y_test, y_pred_lr, average="weighted", zero_division=0))
    mlflow.log_metric("f1_weighted", f1_score(y_test, y_pred_lr, average="weighted", zero_division=0))
    mlflow.log_metric("roc_auc_weighted", roc_auc_lr)
    mlflow.log_metric("cv_f1_mean", cv_scores_lr.mean())
    mlflow.log_metric("cv_f1_std", cv_scores_lr.std())
