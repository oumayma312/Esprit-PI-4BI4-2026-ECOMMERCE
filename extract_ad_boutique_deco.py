...
def main():
    ...
    print("Theme: Boutique Déco")
    print("=" * 60)
    
    # Chemin du fichier HTML
    html_file = r'c:\Users\MSI\Desktop\Scraping_adlibrary\Ad Library_artartisant.html'
    
    # Fichier de sortie Excel
    output_excel = r'c:\Users\MSI\Desktop\Scraping_adlibrary\facebook_ads_boutique_deco.xlsx'
            ...
            for idx, row in df.iterrows():
                ...
                for column, value in row.items():
                    ...
                    if pd.isna(value) or value == '':
                        ...
                        if len(display_value) > 100 and column in ['URL lien publicité', 'Description produit']:
