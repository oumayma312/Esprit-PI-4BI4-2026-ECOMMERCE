...
def models_status() -> dict[str, dict[str, str | bool]]:
    ...
    return {
        "supplier": {
            "path": artifact_display_path(SUPPLIER_MODEL_PATH),
            "exists": artifact_exists(SUPPLIER_MODEL_PATH),
        },
        "sell": {
            "path": artifact_display_path(SELL_MODEL_PATH),
            "exists": artifact_exists(SELL_MODEL_PATH),
        },
        "promote": {
            "path": artifact_display_path(PROMOTE_MODEL_PATH),
            "exists": artifact_exists(PROMOTE_MODEL_PATH),
        },
        "campaign": {
            "path": str(Path(CAMPAIGN_SUMMARY_PATH)),
            "exists": os.path.exists(CAMPAIGN_SUMMARY_PATH),
        },
        "sougui": {
